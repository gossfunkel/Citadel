...
public class GameClient implements Runnable {
	...
	private void parsePacket(byte[] data, InetAddress address, int port) {
		...
		case LOGIN: 
			...
			/*TODO OnlinePlayer player = new OnlinePlayer(packet.x(), packet.y(), game,
	...
	public OnlinePlayer makePlayer(Vector3f pos, String usnm, InetAddress ip, int port) {
		return new OnlinePlayer(pos, game.getTimer(), usnm, ip, port);
	}
